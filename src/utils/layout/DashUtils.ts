...
export const RemoveParamsWindow = () => {
  const drawer = parent.querySelector(
    "body > div:nth-child(8) > div:nth-child(2) > div > div.GI-BUHVBCWC > div"
  );

  const drawerDiv = parent.querySelector(
    "body > div:nth-child(7) > div:nth-child(2) > div > div.GI-BUHVBPVC"
  );
  drawerDiv?.remove();
  drawer?.remove();
...
export const RemoveTopBar = () => {
  ...
  const topBar = parent.querySelector(
    "body > div:nth-child(7) > div:nth-child(2) > div > div.GI-BUHVBPVC.default_container > div > div > div > div > div:nth-child(3)"
  );
